...
if (http2) {
  ...
  app.get("/", function(req, res) {
    res
      ...
      .end(javascript);
    res
      .push("/css/main.css", { response: { "content-type": "text/css" } })
      .end(stylesheet);
    res
      .push("/css/exo-medium-webfont.woff", {
        response: { "content-type": "font/woff" }
      })
      .end(font);
    res
      .push("/css/exo-medium-webfont.woff2", {
        response: { "content-type": "font/woff2" }
      })
      .end(font2);
    res
      .push("/imgs/logo.svg", { response: { "content-type": "image/svg+xml" } })
      .end(logo);
    res
      .push("/imgs/like.svg", { response: { "content-type": "image/svg+xml" } })
      .end(like);
