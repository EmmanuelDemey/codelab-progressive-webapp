window.onload = function() {
  ...
  if (!navigator.onLine) {
    ...
    promise = fetch("/articles").then(result => result.json());
  }
...
function displayData(data) {
  ...
  highlight.querySelector(".description").innerHTML =
    data.highlight.description;
  highlight.querySelector(".info li:first-child").innerHTML =
    data.highlight.date;
  highlight.querySelector(".info li:nth-child(2)").innerHTML = `${data.highlight
    .like} j'aime`;
